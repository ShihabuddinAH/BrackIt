class TournamentRegistration {
  ...
  async openRegistrationModal(tournamentId) {
    console.log(
      "TournamentRegistration: Opening modal for tournament ID:",
      tournamentId
    );
  ...
  async checkEligibility(tournamentId) {
    console.log(
      "TournamentRegistration: Checking eligibility for tournament ID:",
      tournamentId
    );
    ...
    try {
      ...
      console.log("TournamentRegistration: Sending request:", requestData);
